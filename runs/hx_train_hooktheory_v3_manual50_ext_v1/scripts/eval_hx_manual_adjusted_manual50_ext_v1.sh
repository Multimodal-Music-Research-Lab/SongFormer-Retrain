...
RUN=/mnt/ssd/hbli/songformer/runs/hx_train_hooktheory_v3_manual50_ext_v1
CKPT=${1:-${RUN}/results/train_output_42/model.ckpt-12000.pt}
CKPT_TAG=$(basename "${CKPT}")
CKPT_TAG=${CKPT_TAG%.pt}
RESULT_TAG=${2:-${CKPT_TAG}}
CFG=${REPO}/runs/hx_train_hooktheory_v3_manual50_ext_v1/configs/SongFormer.yaml
...
PRED_DIR=${RUN}/results/bench_pred/hx_${RESULT_TAG}
EST_DIR=${RUN}/results/eval/hx_${RESULT_TAG}/est_txt
METRICS_DIR=${RUN}/results/eval/hx_manual_adjusted_${RESULT_TAG}/metrics_per_class
