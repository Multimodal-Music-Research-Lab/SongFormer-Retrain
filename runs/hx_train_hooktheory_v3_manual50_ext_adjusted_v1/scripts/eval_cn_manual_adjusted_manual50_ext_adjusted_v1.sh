...
SCP=/mnt/ssd/hbli/songformer/runs/hx_retrain_v1/results/cn_bench.scp
ANN_DIR=/mnt/ssd/hbli/datasets/songformer/songformbench/data/labels/CN_manual_adjusted
PRED_DIR=${RUN}/results/bench_pred/cn_${RESULT_TAG}
EST_DIR=${RUN}/results/eval/cn_${RESULT_TAG}/est_txt
METRICS_DIR=${RUN}/results/eval/cn_manual_adjusted_${RESULT_TAG}/metrics_per_class
