...
python utils/convert_res2msa_txt.py \
  --input_folder /mnt/ssd/hbli/songformer/runs/hx_train_sxsinger_longformer_probe_hx_only_v1/results/train_pred/json \
  --output_folder /mnt/ssd/hbli/songformer/runs/hx_train_sxsinger_longformer_probe_hx_only_v1/results/eval/train/est_txt

python evaluation/eval_infer_results.py \
  --ann_dir /mnt/ssd/hbli/songformer/runs/hx_train_sxsinger_longformer_probe_hx_only_v1/results/eval/train/ann_txt \
  --est_dir /mnt/ssd/hbli/songformer/runs/hx_train_sxsinger_longformer_probe_hx_only_v1/results/eval/train/est_txt \
  --output_dir /mnt/ssd/hbli/songformer/runs/hx_train_sxsinger_longformer_probe_hx_only_v1/results/eval/train/metrics \
